...
data_all_methods <- data_all_methods[!grepl('FullyRandom', data_all_methods$RandStrobeMethod),]
...
data_all_methods$RandStrobeMethod[data_all_methods$RandStrobeMethod == "GuoPibri"] <- "l_{XOR}-f_{+}"

levels(data_all_methods$RandStrobeMethod) <- c(levels(data_all_methods$RandStrobeMethod), 'MOD')
data_all_methods$RandStrobeMethod[data_all_methods$RandStrobeMethod == "SahlinMod"] <- 'l_{MOD}-f_{XOR}'

levels(data_all_methods$RandStrobeMethod) <- c(levels(data_all_methods$RandStrobeMethod), "AND")
data_all_methods$RandStrobeMethod[data_all_methods$RandStrobeMethod == "Shen"] <- "l_{AND}-f_{XOR}"

levels(data_all_methods$RandStrobeMethod) <- c(levels(data_all_methods$RandStrobeMethod), "BC")
data_all_methods$RandStrobeMethod[data_all_methods$RandStrobeMethod == "SahlinBitCount"] <- "l_{BC}-f_{+}"

levels(data_all_methods$RandStrobeMethod) <- c(levels(data_all_methods$RandStrobeMethod), "CC")
data_all_methods$RandStrobeMethod[data_all_methods$RandStrobeMethod == "LiuPatroLi"] <- "l_{CC}-f_{CC}"

levels(data_all_methods$RandStrobeMethod) <- c(levels(data_all_methods$RandStrobeMethod), "XV")
data_all_methods$RandStrobeMethod[data_all_methods$RandStrobeMethod == "XorVar"] <- "l_{XV}-f_{+}"

levels(data_all_methods$RandStrobeMethod) <- c(levels(data_all_methods$RandStrobeMethod), "MAMD")
data_all_methods$RandStrobeMethod[data_all_methods$RandStrobeMethod == "MAMod"] <- "l_{MAMD}-f_{XOR}"
