...
for(i in 1:ncol(new_data))
{
  ...
  plot_now <- plot_now + labs(title = paste(names(new_data)[i], added_str),
              x = "Hashes", y =  paste("Normalized ", names(new_data)[i], sep = ""))
#  print(paste("../EvaluationResults/Figures/", names(new_data)[i], ".png",sep = ""))
  png(filename=paste("../EvaluationResults/Figures/", names(new_data)[i], ".png",sep = ""), width=3000, height= 3000)
  print(plot_now)
  dev.off()
  ggsave( filename = paste("../EvaluationResults/Figures/", names(new_data)[i], ".pdf",sep = ""), 
