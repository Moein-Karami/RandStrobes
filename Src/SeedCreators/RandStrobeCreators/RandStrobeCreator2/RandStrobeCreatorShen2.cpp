#include "RandStrobeCreatorShen2.hpp"

RandStrobeCreatorShen2::RandStrobeCreatorShen2(Hasher* hasher, Comparator* comparator, size_t kmer_len,
...
std::vector<Seed*> RandStrobeCreatorShen2::creat_seeds(const std::string& seq, const std::vector<uint64_t>& hashes)
{
